...
- Add `npm run live:cli-timing`: same `live:timing` models through official Cursor CLI and a User API Key, no HTTP gateway. The redacted baseline and gateway-vs-CLI chart are in `docs/evidence/pr-performance-diff.md`.
